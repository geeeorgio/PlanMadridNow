...
const OnboardingScreen3 = () => {
  ...
  const handleNext = () => navigation.navigate('OnboardingScreen4');
    ...
    >
      ...
      >
        <CustomText extraStyle={styles.title}>
          After the quiz, get the one location in Madrid that truly fits you.
          Explore photos, stories, and tips for your destination.
        </CustomText>
